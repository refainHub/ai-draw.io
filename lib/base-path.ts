 ...
 *
 * Example: If deployed at https://example.com/refain-draw, this returns "/refain-draw"
 * For root deployment, this returns ""
 *
 * Set NEXT_PUBLIC_BASE_PATH environment variable to your subdirectory path (e.g., /refain-draw)
 */
 ...
 * @param assetPath - Asset path (e.g., "/chain-of-thought.txt")
